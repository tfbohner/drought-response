...
bivar <- bivar + annotation_custom(grob=mapgrob, ymin = 800, ymax = 1150, xmin = 4.4, xmax = 7.3)

plot_grid(
  plot_grid(
    plot_grid(p2, bivar, ncol=1, labels = c('a)', 'b)')), 
    drought, ncol=2, rel_widths = c(.30, .6), labels=c('a)', 'c)')),
