...
```{r recov_full ac}
ac_dat <- get_scaled_data(l_leg, "AC")
ac_pred <- get_pred_data(ac_dat, recov_full_ac)

ggplot(ac_pred, aes(x = drought_fx, y = .value, color = Region)) +
...
ggplot(ac_pred, aes(x = drought_fx, y = .value)) +
...
```{r recov_full pj}
pj_dat <- get_scaled_data(l_leg, "PJ")
pj_pred <- get_pred_data(pj_dat, recov_full_pj)

ggplot(pj_pred, aes(x = drought_fx, y = .value, color = Region)) +
...
ggplot(pj_pred, aes(x = drought_fx, y = .value)) +
...
```{r recov_full pl}
pl_dat <- get_scaled_data(l_leg, "PL")
pl_pred <- get_pred_data(pl_dat, recov_full_pl)

ggplot(pl_pred, aes(x = drought_fx, y = .value, color = Region)) +
...
ggplot(pl_pred, aes(x = drought_fx, y = .value)) +
